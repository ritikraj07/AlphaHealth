...
export default function AddEmployeeFromExcelModal() {
  ...
  return (
    <View style={{ marginTop: 0 }}>
      ...
      >
        <FontAwesome6 name="users" size={24} color="#e3e3e3ff" />
        <Text style={styles.actionLabel}>Add Employee from Excel</Text>
      </TouchableOpacity>
