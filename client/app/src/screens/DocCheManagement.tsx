...
import { Ionicons, Feather, EvilIcons, FontAwesome6, AntDesign } from "@expo/vector-icons";

export default function DocCheManagement() {


  return (
    <ScrollView style={[styles.container, {backgroundColor: 'rgba(255, 255, 255, 1)'}]}
     ...
     >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>View and manage doctors and chemists in your network</Text>
        </View>
 ...
 <TouchableOpacity style={styles.applyButton}>
        ...
        <TouchableOpacity style={[styles.applyButton, {backgroundColor:"white"}]}>
          <Text style={[styles.applyButtonText, {color:"black"}]}>Add Chemist</Text>
        </TouchableOpacity>
        </View>
