...
const emailTemplates = require("./src/static/emailTemplates");
...
let emp = {
    name: 'Mike',
    email: 'swastik.online.247@gmail.com',
...
async function checkmail() {
    let res = await mailer.sendEmployeeCreationEmail(emp, "initialPassword");
    console.log(res);
    return res;
}
...
// console.log(emailTemplates.getEmployeeCreationTemplate(emp))
